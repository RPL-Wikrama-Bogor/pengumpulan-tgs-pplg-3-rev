...
section{
    ...
    min-height: 100vh;
    width: 100%;
    background: url(img/foto_background.jpg)no-repeat;
        ...
        <div class="foem-value">
            <form action="" method="post">
                ...
                <div class="inputbox">
                    ...
                    <input type="number" required name="hh" max="24">
                    <label for="">jam</label>
                </div>
                <div class="inputbox">
                    <ion-icon name="lock-closed-outline"></ion-icon>
                    <input type="number" required name="mm" max="60">
                    <label for="">menit</label>
                </div>
                <div class="inputbox">
                    <ion-icon name="lock-closed-outline"></ion-icon>
                    <input type="number" required name="ss" max="60">
