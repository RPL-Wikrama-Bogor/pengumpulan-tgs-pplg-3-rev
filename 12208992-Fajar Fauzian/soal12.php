                    ...
                    <form action="" method="post">
                         ...
                         <div class="form-group">
                              <div class="field" for="jam">
                                   <label for="jam"></label>
                                   <input type="number" id="jam" name="jam" autofocus placeholder="Jam" min="0" max="23" required>
                              </div>
                              <div class="field" for="jam">
                                   <label for="menit"></label>
                                   <input type="number" id="menit" name="menit" autofocus placeholder="Menit" min="0" max="59" required>
                              </div>
                              <div class="field" for="jam">
                                   <label for="detik"></label>
                                   <input type="number" id="detik" name="detik" autofocus placeholder="Detik" min="0" max="59" required>
                              </div>
