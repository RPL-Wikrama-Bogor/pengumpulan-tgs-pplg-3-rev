...
<body>
    <form action="" method="post">
        ...
        <div class="test">
            <input type="text" name="hh" placeholder="Jam" min="0" maxlength="4">
            <input type="text" name="mm" placeholder="Menit" maxlength="2">
            <input type="text" name="ss" placeholder="Detik" maxlength="2">
    ...
    ?>
        <div class="hasil">
            ...
            <h1 align="center"><?php echo " $hari Hari: $hh_str Jam: $mm_str Menit: $ss_str Detik";
                            } ?></h1>
        </div>
